...
wget -O /tmp/argon.tar.gz https://github.com/jerrykuku/luci-theme-argon/archive/refs/tags/v2.4.6.tar.gz
tar -xzf /tmp/argon.tar.gz -C package/
mv package/luci-theme-argon-2.4.6 package/luci-theme-argon
